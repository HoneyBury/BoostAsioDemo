...
set(PROJECT_CONAN_FIRST_DEPENDENCIES "fmt;spdlog;nlohmann_json;hiredis;boost::headers")
...
if(BOOST_USE_CONAN_DEPS)
    ...
    if(NOT TARGET boost::headers)
        project_record_missing_conan_dependency("boost::headers")
    endif()
    if(ENABLE_TESTING)
    ...
    if(fmt_FOUND AND spdlog_FOUND AND nlohmann_json_FOUND AND OpenSSL_FOUND AND hiredis_FOUND AND TARGET boost::headers)
