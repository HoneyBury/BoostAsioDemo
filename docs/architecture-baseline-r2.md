...
> 日期：`2026-05-16`  
> 范围：Actor runtime 本地投递、跨 core mailbox drain、actor 创建、shutdown per actor 成本、内存分配、SPSC mailbox。  
...
|---|---:|---:|---:|---:|
| `actor_local_tell_dispatch` | 2.1 | 2.2 | 2.2 | 421493 |
| `actor_cross_core_tell_drain_dispatch` | 3.1 | 3.2 | 3.2 | 271079 |
| `actor_create` | 0.7 | 0.8 | 1.1 | 1067520 |
| `actor_shutdown_per_actor` | 0.34852 | 0.34852 | 0.34852 | 2869280 |
| `bump_arena_alloc` | 0 | 0.1 | 0.1 | 16225900 |
| `object_pool_acquire_release` | 0.1 | 0.1 | 0.1 | 10640600 |
| `spsc_queue_enqueue_dequeue` | 0 | 0.1 | 0.1 | 11919000 |
