...
> **配置字段成熟度**（哪些启动生效 / 哪些热更新生效 / 哪些仅预留）：运维可读 **`docs/v1-config-maturity.md`**；矩阵锚点 **`docs/v1-maturity-matrix.md` §5.1**。**启动 / reload / shutdown 顺序与受控语义**：**`docs/v1-runtime-lifecycle.md`**（**v1.1.13–v1.1.14**）。
