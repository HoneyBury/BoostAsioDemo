...
- **下一维护版**：`v1.1.11`（T11：admin **权限 / 审计** 最小规则）。**治理成熟度冻结**见 `docs/v1-governance-layers.md` **§6**（**v1.1.10**）。**入口分层（T10）** 见同文 §1–§5（**v1.1.9**）。**房/战边界与 `transfer_session`** 见 `docs/v1-room-battle-boundary.md`（**v1.1.8**）。
